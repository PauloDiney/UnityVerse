...
<head>
    ...
    <link rel="stylesheet" href="../css/unreal.css">
...
<body>
    ...
    ?>
    <section class="unreal-center" data-aos="fade-up" data-aos-duration="2000">
        <div class="unreal-container">
            <section class="unreal" data-aos="fade-up" data-aos-duration="2000">
                <img src="../img/unreal.png" alt="UnityVerse Logo">
            </section>
        </div>
    </section>
    <section class="unreal-info" data-aos="fade-up" data-aos-duration="2000">
        <div class="unreal-text">
        ...
        <video src="../Movies/3.mp4" loop autoplay muted></video>
    </section>
