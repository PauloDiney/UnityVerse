...
<body>
    ...
    ?>
    <section class="base-meio" data-aos="fade-up" data-aos-duration="3000">
        <div class="base-container">
            <section class="base" data-aos="fade-up" data-aos-duration="3000">
                <img src="./view/img/logo.png" alt="">
                <h2>UnityVerse</h2>
            </section>
            <section class="base-ant" data-aos="fade-up" data-aos-duration="3000">
                <h1>Desenvolva, inspire, jogue.</h1>
            </section>
            <section class="sec-p" data-aos="fade-up" data-aos-duration="3000">
            ...
            <section class="botao-start" data-aos="fade-up" data-aos-duration="3000">
                <button>Começar!</button>
            </section>
        </div>
        <section class="base-lado" data-aos="fade-left" data-aos-duration="3000">
